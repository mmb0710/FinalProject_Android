...
import algonquin.cst2335.finalproject.data.local.AppDatabaseGurminder;
import algonquin.cst2335.finalproject.data.local.WordsDao;
import algonquin.cst2335.finalproject.data.model.wordsapi.Word;
import algonquin.cst2335.finalproject.data.remote.wordsapi.WordsApiService;
...
public class WordsRepo {
    ...
    private WordsRepo(Application app){
        AppDatabaseGurminder appDatabase = AppDatabaseGurminder.getInstance(app);
  ...
  // find if word exists in list of favourite words
    ...
    private static class removeListAsyncTask extends AsyncTask<List<Word>, Void, Boolean>{
        private final MainActivityGurminder.OnRemoveSelectedWords mListener;
        private final WordsDao mAsyncTaskDao;
        removeListAsyncTask(MainActivityGurminder.OnRemoveSelectedWords mListener, WordsDao dao) {
